...
"""
process isbn13 feature first and generate file Train_data_2 and Test_data_2
"""
...
"""
process other features, such as using Bayesian target encoding.
"""
...
# write to file
train = pd.DataFrame(train)
train.to_csv('./processed_data/train_processed_language_author_publisher_nation_date.csv', header=train_header, index=None)

test = pd.DataFrame(test)
test.to_csv('./processed_data/test_processed_language_author_publisher_nation_date.csv', header=test_header, index=None)
