...
regr = MLPRegressor(alpha=1e-5, hidden_layer_sizes=(20, 2), random_state=1, max_iter=1000)
score = -np.mean(cross_val_score(regr, x_train, y_train, cv=10, scoring='neg_mean_squared_error'))
print('10-CV mse:', score)
# 10-CV mse: 0.033640165513129094ran

# predict test set
regr2 = MLPRegressor(alpha=1e-5, hidden_layer_sizes=(20, 2), random_state=1, max_iter=1000)
